...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(KC_KP_7, KC_KP_8, KC_KP_9, KC_PMNS, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_P1, KC_P2, KC_P3, KC_NUMLOCK, KC_P0, KC_PDOT, KC_PENT, MO(1)),
    [1] = LAYOUT(RGB_TOG, RGB_MOD, RGB_M_K, RGB_M_X, RGB_MOD, RGB_RMOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_SPI, RGB_SPD, RGB_TOG, KC_TRNS),
};
